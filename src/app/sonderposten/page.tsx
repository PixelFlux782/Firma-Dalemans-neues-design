    ...
    <section className="relative -mx-5 overflow-hidden bg-premium-ink sm:-mx-6 md:mx-0 md:rounded-[2.5rem]">
      <div className="grid lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="relative min-h-[360px] bg-premium-highlight lg:min-h-[560px]">
          <Image src={encodeURI("/images/curated/Sonderposten/kunstoffschalenstuhl-restposten.webp")} alt="Grauer Kunststoffschalenstuhl als Beispiel für wechselnde Lagerware" fill priority sizes="(min-width: 1024px) 45vw, 100vw" className="object-cover object-center" />
        </div>
      </div>
    </section>
